...
import { CocktailProps } from "@/components/CocktailCard";
        ...
        <Grid item>
          ...
          >
            <CardHeader
              ...
              //   </IconButton>
              // }
              title={cocktail ? cocktail.name : "Loading..."}
              // subheader={cocktail ? new Date().toString() : ""}
            />
            <CardMedia
              component="img"
              height="280"
              image={cocktail ? cocktail.imgUrl : "/images/cocktails.png"}
              alt={cocktail ? cocktail.name : ""}
              sx={{ objectFit: "cover" }}
            />
            <CardContent>
              <Typography variant="body2" color="#363537">
